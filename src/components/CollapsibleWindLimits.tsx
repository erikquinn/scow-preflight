...
export default function CollapsibleWindLimits() {
  ...
  return (
    <div className="mt-8 bg-blue-50 dark:bg-blue-800/50 rounded-xl border border-blue-100 dark:border-blue-700/50 overflow-hidden shadow-sm">
      <div
        className="px-5 py-3 bg-blue-100/50 dark:bg-blue-900/50 border-b border-blue-100 dark:border-blue-700/50 flex justify-between items-center cursor-pointer hover:bg-blue-100/70 dark:hover:bg-blue-900/70 transition-colors"
